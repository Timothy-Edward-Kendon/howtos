...
## ExternalForcing option - dependencies

oceanWave3D.C is dependent on externalWaveForcing.C



```sh
cd /private/tike/OpenFOAM/tike-v1912/applications/utilities/waves2Foam/src/waves2Foam/Make/linux64GccDPInt32Opt/waveTheories/externalWaveForcing```
